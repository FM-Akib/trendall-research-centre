...
Description: This component renders a section for different types of searches.
*/
                ...
                <div className="rounded-md shadow-md bg-white text-gray-800 mb-4">
                    ...
                    <div className="flex flex-col justify-between p-6 space-y-8">
                        <div className="space-y-2">
                            ...
                            <p className="text-gray-800">To search artefact click below.</p>
                        </div>
                        {/* Link to Artefact Search */}
