...
Header Comment: 
Component: News
Description: This component fetches and displays news items.
*/
...
const News = () => {
    ...
    // Fetching news data from JSON file on component mount
    useEffect(() =>{
        fetch('news.json')
    ...
    return (
        <div>
            <div className="mt-8">
                {/* Mapping through news items */}
                {
                    news.map(anews=> 
                        <div key={anews.id} className="px-4 py-4 mb-4 mx-5 font-normal bg-blue-100 rounded-lg">
