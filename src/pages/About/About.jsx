...
const About = () => {
    ...
    <div className="bg-cover bg-center text-center overflow-hidden">
            <img className="min-h-[500px]" src="https://i.ibb.co/p111YCZ/study-room-view.jpg" alt="" />
    </div>
    <div className="max-w-3xl mx-auto">
        <div
            ...
            <div className="bg-white relative top-0 -mt-32 p-5 sm:p-10">
                <h1 href="#" className="text-gray-900 font-bold text-3xl mb-2">ABOUT</h1>
                ...
                {/* <h3 className="text-2xl font-bold my-5">THE BEAZLEY ARCHIVE</h3> */}
